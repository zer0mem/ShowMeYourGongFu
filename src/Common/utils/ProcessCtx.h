...
public:
	...
	{
		ProcessNotifyRoutineEx(process, processId, createInfo);
	}

	~CProcessContext()
	{
//TODO : PsGetCurrentProcess exchange with Id, by ObrefDeref!!
		ProcessNotifyRoutineEx(/**/PsGetCurrentProcess(), m_processId, NULL);
	}
